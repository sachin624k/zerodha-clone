            ...
            <div className='row p-5'>
                ...
                <div className='col-7 p-5'>
                    ...
                    <div className='text-center'>
                        <a href='' className='mx-5 mt-3 d-inline-block' style={{ textDecoration: "none", fontSize: "13px", color: "#387ed1"}}>Explore our products <i class="fa fa-long-arrow-right" style={{fontSize: "12px", color: "#387ed1"}} aria-hidden="true"></i>
                        </a>
                        <a href='' style={{ textDecoration: "none", fontSize: "13px", color: "#387ed1" }}>Try kite demo <i class="fa fa-long-arrow-right" style={{fontSize: "12px", color: "#387ed1"}} aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
